...
<html>
  <head>
    ...
    <title>5. Seamless interoperation with the DOM &#8212; Transcrypt 3.9.4 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href=""><span class="section-number">5. </span>Seamless interoperation with the DOM</a></li> 
      </ul>
    </div>  
...
<p>In using the fabric.js JavaScript library this for example, the only thing differing from plain JavaScript is that <em>new &lt;constructor&gt;</em> is replaced by <em>__new__ (&lt;constructor&gt;)</em>.</p>
<table class="docutils align-default" id="code-pong">
<colgroup>
<col style="width: 45%" />
<col style="width: 55%" />
</colgroup>
...
<section id="four-ways-of-integration-with-javascript-libraries">
<h3><span class="section-number">6.1.1. </span>Four ways of integration with JavaScript libraries<a class="headerlink" href="#four-ways-of-integration-with-javascript-libraries" title="Permalink to this headline">¶</a></h3>
<p>There are four ways to integrate Transcrypt applications with existing JavaScript libraries.</p>
<ol class="arabic simple">
<li><p>The simplest way is to use the library as is, without any encapsulation. In this way all symbols of that library will be in the global namespace. While many JavaScript programmers don’t seem to mind that, many Python programmers do. For example, in the Terminal demo, the JavaScript module is imported using a <em>&lt;script&gt;</em> tag in the HTML header:</p></li>
</ol>
<div class="literal-block-wrapper docutils container" id="id6">
<div class="code-block-caption"><span class="caption-text">terminal_demo.html</span><a class="headerlink" href="#id6" title="Permalink to this code">¶</a></div>
...
<li><p>Another way is to encapsulate the JavaScript library as a whole in a Transcrypt module. In the distribution this is done for the <em>fabric</em> module, that encapsulates <em>fabric.js</em> and is imported in the Pong example. In this way the global namespace stays clean.</p></li>
<li><p>A third way is to write a complete Pythonic API for the JavaScript library. This is overkill in most cases and makes it harder to keep up with new versions of the library. Note that Transcrypt was designed to make seamless cooperation between Transcrypt and JavaScript libraries possible without any glue code.</p></li>
<li><p>The fourth way is one of the most convenient, but it only works if you are using something like Webpack or Parcel to process and bundle the JavaScript files. In that case, you can use the Node <em>require()</em> function to dynamically load JavaScript libraries into the namespace.</p></li>
</ol>
<div class="literal-block-wrapper docutils container" id="id7">
<div class="code-block-caption"><span class="caption-text">nodejs_demo.py</span><a class="headerlink" href="#id7" title="Permalink to this code">¶</a></div>
...
<p>In most cases, approach 2 strikes a good balance between effort and yield. As can be seen below, the effort involved is minimal.</p>
<div class="literal-block-wrapper docutils container" id="id8">
<span id="code-encaps-fabric"></span><div class="code-block-caption"><span class="caption-text">The encapsulation layer for fabric.js</span><a class="headerlink" href="#id8" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">jquery_demo.py</span><a class="headerlink" href="#id9" title="Permalink to this code">¶</a></div>
...
<td><div class="literal-block-wrapper docutils container" id="id10">
<div class="code-block-caption"><span class="caption-text">jquery_demo.js</span><a class="headerlink" href="#id10" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">ios_app.py</span><a class="headerlink" href="#id11" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">ios_app.html</span><a class="headerlink" href="#id12" title="Permalink to this code">¶</a></div>
...
<tbody>
<tr class="row-odd"><td><div class="literal-block-wrapper docutils container" id="id13">
<div class="code-block-caption"><span class="caption-text">cache.manifest</span><a class="headerlink" href="#id13" title="Permalink to this code">¶</a></div>
...
<p>The <em>D3.js</em> graphics library offers animation by data driven DOM manipulation. It combines well with class based object oriented programming as supported by Transcrypt, leading to applications that are easy to understand and maintain.</p>
<table class="docutils align-default">
<colgroup>
<col style="width: 46%" />
<col style="width: 54%" />
...
<div class="code-block-caption"><span class="caption-text">d3js_demo.py</span><a class="headerlink" href="#id14" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">d3js_demo.js</span><a class="headerlink" href="#id15" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">react_demo.py</span><a class="headerlink" href="#id16" title="Permalink to this code">¶</a></div>
...
<td><div class="literal-block-wrapper docutils container" id="id17">
<div class="code-block-caption"><span class="caption-text">react_demo.js</span><a class="headerlink" href="#id17" title="Permalink to this code">¶</a></div>
...
<tbody>
<tr class="row-odd"><td><div class="literal-block-wrapper docutils container" id="id18">
<div class="code-block-caption"><span class="caption-text">riot_demo.html</span><a class="headerlink" href="#id18" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">sample.tag, a classic Riot tag</span><a class="headerlink" href="#id19" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">sample.js, compiled by Riot</span><a class="headerlink" href="#id20" title="Permalink to this code">¶</a></div>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="o">//</span> <span class="n">vim</span><span class="p">:</span> <span class="n">ft</span><span class="o">=</span><span class="n">html</span>
...
<div class="code-block-caption"><span class="caption-text">riot_tag.py, baseclass of all Transcrypt Riot tags</span><a class="headerlink" href="#id21" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">riot_tag.js, compiled by Transcrypt</span><a class="headerlink" href="#id22" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">riot_demo.py, a derived Transcrypt Riot tag class</span><a class="headerlink" href="#id23" title="Permalink to this code">¶</a></div>
...
<td><div class="literal-block-wrapper docutils container" id="id24">
<div class="code-block-caption"><span class="caption-text">riot_demo.js, compiled by Transcrypt</span><a class="headerlink" href="#id24" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">terminal_demo.html</span><a class="headerlink" href="#id25" title="Permalink to this code">¶</a></div>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="o">&lt;</span><span class="n">html</span><span class="o">&gt;</span>
    <span class="o">&lt;</span><span class="n">head</span><span class="o">&gt;</span>
        <span class="o">&lt;</span><span class="n">script</span> <span class="nb">type</span><span class="o">=</span><span class="s2">&quot;module&quot;</span><span class="o">&gt;</span><span class="kn">import</span> <span class="o">*</span> <span class="k">as</span> <span class="n">terminal_demo</span> <span class="kn">from</span> <span class="s2">&quot;./__target__/terminal_demo.js&quot;</span><span class="p">;</span><span class="o">&lt;/</span><span class="n">script</span><span class="o">&gt;</span>
    <span class="o">&lt;/</span><span class="n">head</span><span class="o">&gt;</span>
...
<div class="code-block-caption"><span class="caption-text">terminal_demo.py</span><a class="headerlink" href="#id26" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">index.html</span><a class="headerlink" href="#id27" title="Permalink to this code">¶</a></div>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="o">&lt;</span><span class="n">html</span><span class="o">&gt;</span>
<span class="o">&lt;</span><span class="n">head</span><span class="o">&gt;</span>
...
<tbody>
<tr class="row-odd"><td><div class="literal-block-wrapper docutils container" id="id28">
<div class="code-block-caption"><span class="caption-text">index.js</span><a class="headerlink" href="#id28" title="Permalink to this code">¶</a></div>
...
<tbody>
<tr class="row-odd"><td><div class="literal-block-wrapper docutils container" id="id29">
<div class="code-block-caption"><span class="caption-text">main.py</span><a class="headerlink" href="#id29" title="Permalink to this code">¶</a></div>
...
<span class="w">    </span><span class="sd">&#39;&#39;&#39;Main function of the program (called from index.js)&#39;&#39;&#39;</span>
...
<li><a class="reference internal" href="#four-ways-of-integration-with-javascript-libraries">6.1.1. Four ways of integration with JavaScript libraries</a></li>
...
<li><a class="reference internal" href="#example-using-the-parcel-js-bundler-to-package-a-set-of-modules-written-in-diverse-programming-languages">6.8. Example: Using the Parcel.js bundler to package a set of modules written in diverse programming languages</a></li>
  ...
  <p class="topless"><a href="supported_constructs.html"
                        title="previous chapter"><span class="section-number">4. </span>Systematic code examples: a guided tour of Transcrypt</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="autotesting_transcrypt.html"
                        title="next chapter"><span class="section-number">7. </span>Autotesting Transcrypt code</a></p>
